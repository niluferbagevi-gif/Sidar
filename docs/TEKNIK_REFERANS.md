...
- **Webhook / federation:** `ENABLE_EVENT_WEBHOOKS`, `GITHUB_WEBHOOK_REQUIRE_SIGNATURE`, `AUTONOMY_WEBHOOK_SECRET`, `ENABLE_SWARM_FEDERATION`, `SWARM_FEDERATION_SHARED_SECRET`
