...
|---|---:|---|
| `web_server.py` | 3006 | Web/API kontrol düzlemi için route/middleware/lifecycle wrapper azaltımı sürmeli; plugin sandbox policy üretimde fail-closed. |
