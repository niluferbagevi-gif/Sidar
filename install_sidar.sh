...
install_pyright_lsp_tool() {
    ...
    warn "Pyright LSP proje ortamında bulunamadı; gerekirse 'uv add --dev pyright' ile manuel kurabilirsiniz. Proje bağımlılığı fallback'i olarak uv add --dev pyright deneniyor."
