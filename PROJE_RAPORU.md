...
> **Son Güncelleme:** 2026-03-18 (v3.0.17 — FAZ-5 orta öncelikli güvenlik hardening tamamlandı: O-1..O-6 tüm bulgular kapatıldı. O-1: asyncio.Lock lifespan başlatma teyit. O-2: Config.BASE_DIR sınır kontrolü eklendi. O-3: DOCKER_REQUIRED env bayrağı eklendi. O-4: asyncio.to_thread Ollama wrap teyit. O-5: WS Sec-WebSocket-Protocol handshake teyit. O-6: shell blocklist eklendi. Güvenlik puanı 9.2→9.6. Tek kalan açık bulgu: D-6.)
