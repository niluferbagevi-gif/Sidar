...
> **Son Güncelleme:** 2026-03-18 (v3.0.14 — Tüm kaynak dosyalar yeniden satır satır incelendi. `agent/registry.py` (186 satır, AgentRegistry marketplace), `agent/swarm.py` (370 satır, SwarmOrchestrator), `plugins/upload_agent.py` (10 satır) dosya ağacına eklendi. Satır sayıları güncellendi: web_server.py +392, core/db.py +281, core/llm_client.py +84, agent/core/event_stream.py +28, core/rag.py +35 ve diğerleri. Test sayımları güncellendi: 109→130 modül, 111→132 dosya, 21.765→30.613 satır. Web UI: 4.240→4.392 satır.)
> **Proje Sürümü:** 3.0.0
