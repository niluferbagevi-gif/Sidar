...
| 2 | Vanilla JS UI ölçeklenme riski | `web_ui/*.js` | Dosyalar büyümeye devam ediyor (chat.js 721, app.js 710, sidebar.js 421 satır); event stream + dashboard + auth durumları genişledikçe DOM/state yönetimi karmaşıklaşıyor. Component tabanlı çatı (React/Vue) ihtiyacı sürüyor. | Orta | ⚠ **AÇIK** |
