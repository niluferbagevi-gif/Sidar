...
## 3. Modül Bazında Detaylı Analiz (Modüler Yapı)

[⬆ İçindekilere Dön](#içindekiler)

Bu bölümdeki detaylı teknik analizler, bakım kolaylığı için `docs/module-notes/` altındaki modül notlarına taşınmıştır.

### 3.x Modül Notları Dizini

- **3.1 `config.py` — Merkezi Yapılandırma (589 satır)** → `docs/module-notes/config.py.md`
- **3.2 `main.py` — Akıllı Başlatıcı (225 satır)** → `docs/module-notes/main.py.md`
- **3.3 `cli.py` — CLI Arayüzü (232 satır)** → `docs/module-notes/cli.py.md`
- **3.4 `web_server.py` — FastAPI Web Sunucusu (1.376 satır)** → `docs/module-notes/web_server.py.md`
- **3.5 `agent/sidar_agent.py` — Ana Ajan (1.651 satır)** → `docs/module-notes/agent/sidar_agent.py.md`
- **3.6 `agent/auto_handle.py` — Hızlı Yönlendirici (601 satır)** → `docs/module-notes/agent/auto_handle.py.md`
- **3.7 `agent/definitions.py` — Ajan Tanımları (165 satır)** → `docs/module-notes/agent/definitions.py.md`
- **3.7b `agent/tooling.py` — Araç Kayıt ve Şema Yöneticisi (266 satır)** → `docs/module-notes/agent/tooling.py.md`
- **3.7c `agent/base_agent.py` — Temel Ajan Sınıfı (55 satır)** → `docs/module-notes/agent/base_agent.py.md`
- **3.7d `agent/core/supervisor.py` — Yönlendirici (Supervisor) Ajan (164 satır)** → `docs/module-notes/agent/core/supervisor.py.md`
- **3.7e `agent/core/contracts.py`, `event_stream.py`, `memory_hub.py`, `registry.py` — Çekirdek Ajan İletişim Altyapısı** → `docs/module-notes/agent/core/contracts.py.md` (+3 ilgili dosya)
- **3.7f `agent/roles/` — Uzman Ajan Rolleri (Coder, Researcher & Reviewer)** → `docs/module-notes/agent/roles/__init__.py.md` (+3 ilgili dosya)
- **3.8 `core/llm_client.py` — LLM İstemcisi (Ollama + Gemini + OpenAI + Anthropic, 839 satır)** → `docs/module-notes/core/llm_client.py.md`
- **3.9 `core/memory.py` — Konuşma Belleği (DB tabanlı, v3.0)** → `docs/module-notes/core/memory.py.md`
- **3.10 `core/rag.py` — RAG Motoru (783 satır)** → `docs/module-notes/core/rag.py.md`
- **3.11 `managers/security.py` — Güvenlik Yöneticisi (290 satır)** → `docs/module-notes/managers/security.py.md`
- **3.12 `managers/code_manager.py` — Kod Yöneticisi (805 satır)** → `docs/module-notes/managers/code_manager.py.md`
- **3.13 `managers/github_manager.py` — GitHub Yöneticisi (644 satır)** → `docs/module-notes/managers/github_manager.py.md`
- **3.14 `managers/system_health.py` — Sistem Sağlık Yöneticisi (475 satır)** → `docs/module-notes/managers/system_health.py.md`
- **3.15 `managers/web_search.py` — Web Arama Yöneticisi (387 satır)** → `docs/module-notes/managers/web_search.py.md`
- **3.16 `managers/package_info.py` — Paket Bilgi Yöneticisi (322 satır)** → `docs/module-notes/managers/package_info.py.md`
- **3.17 `managers/todo_manager.py` — Görev Takip Yöneticisi (451 satır)** → `docs/module-notes/managers/todo_manager.py.md`
- **3.18 `web_ui/` — Web Arayüzü (Toplam ~4.160 satır)** → `docs/module-notes/web_ui/index.html.md` (+5 ilgili dosya)
- **3.19 `github_upload.py` — GitHub Yükleme Aracı (294 satır)** → `docs/module-notes/github_upload.py.md`
- **3.20 `core/db.py` — Veritabanı ve Çoklu Kullanıcı Altyapısı** → `docs/module-notes/core/db.py.md`
- **3.21 `core/llm_metrics.py` — Telemetri ve Bütçe Yönetimi** → `docs/module-notes/core/llm_metrics.py.md`
- **3.22 `migrations/` ve `scripts/` — Geçiş ve Operasyon Araçları** → `docs/module-notes/migrations/env.py.md` (+8 ilgili dosya)
- **3.23 `docker/` ve `runbooks/` — Telemetri ve Production Altyapı Dosyaları** → `docs/module-notes/docker/prometheus/prometheus.yml.md` (+2 ilgili dosya)
...
- **Final Doğrulama Tarihi:** 2026-03-14 (Güncel)
- **Durum:** Tüm kurumsal özellikler (Auth, Multi-User, Sandbox, Observability) kod düzeyinde doğrulanmıştır.
