...
# ===== MERGED FROM tests/test_managers_package_info_extra.py =====
...
class Extra_TestConstructorTimeoutFallbacks:
...
class Extra_TestGetJsonCacheAndHttp:
    def _mgr(self):
        pi = _get_pi()
        return pi.PackageInfoManager()
...
class Extra_TestPypiLatestVersion:
    def _mgr(self):
        pi = _get_pi()
        return pi.PackageInfoManager()
...
class Extra_TestGithubReleases:
    def _mgr(self):
        pi = _get_pi()
        return pi.PackageInfoManager()
...
class Extra_TestGithubLatestRelease:
    def _mgr(self):
        pi = _get_pi()
        return pi.PackageInfoManager()
...
class Extra_TestVersionSortKey:
