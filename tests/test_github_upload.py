...
# ===== MERGED FROM tests/test_github_upload_extra.py =====
...
class Extra_TestRunCommandOutputPaths:
...
class Extra_TestCollectSafeFilesEdgeCases:
...
class Extra_TestMainGitNotInstalled:
...
class Extra_TestMainGitIdentitySetup:
...
class Extra_TestMainOriginSetup:
...
class Extra_TestMainBranchSwitch:
...
class Extra_TestMainTargetBranchPull:
...
class Extra_TestMainUploadFlow:
...
class Extra_TestMainPushRejection:
...
class Extra_TestIsForbiddenPathEdgeCases:
