...
def test_extract_ws_header_token_rejects_malformed_protocol_tokens() -> None:
    token, protocol = security.extract_ws_header_token("sidar.chat.v1, raw token with spaces")
