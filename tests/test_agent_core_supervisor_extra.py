"""
agent/core/supervisor.py için ek birim testleri.
Eksik satırları kapsar: _NullSpan, __init__ TypeError yolu, _delegate hata/metrics,
_route_p2p max hop, run_task tüm intent dalları, QA retry döngüsü.
"""
...
class TestSupervisorInitTypeError:
...
class TestIsRejectFeedbackPayloadExtra:
