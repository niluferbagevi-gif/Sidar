...
# Domain helpers keep this entry point focused on loop orchestration.
# shellcheck source=scripts/autonomous_modules/coverage_agent.sh
source "${SCRIPT_DIR}/scripts/autonomous_modules/coverage_agent.sh"
# shellcheck source=scripts/autonomous_modules/auto_heal.sh
source "${SCRIPT_DIR}/scripts/autonomous_modules/auto_heal.sh"
# shellcheck source=scripts/autonomous_modules/static_analysis.sh
source "${SCRIPT_DIR}/scripts/autonomous_modules/static_analysis.sh"
