...
# Testler ve eski patch yolları için geriye dönük modül değişkeni.
MultimodalPipeline = MultimodalPipelineRuntime
...
class PoyrazAgent(BaseAgent):
    """AGENTS.md 2.3'e göre SEO, kampanya ve multimodal pazarlama ajanı."""
