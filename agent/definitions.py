...
NOT (kaynak doğruluk): Bu listedeki araç adları için runtime source-of-truth `agent/sidar_agent.py` içindeki `_execute_tool` dispatch tablosudur. Çelişki durumunda dispatch tablosunu esas al.
