"""Authentication boundary for the phased ``core.db`` split (Phase 2).

This module now contains the actual implementation for auth-related
records and helpers. The logic has been moved from core.db to here.
"""
