...
class LLMJudge:
    ...
    def __init__(self) -> None:
        ...
        self.auto_feedback_threshold = max(
            ...
            min(
                10.0,
                float(getattr(self.config, "JUDGE_AUTO_FEEDBACK_THRESHOLD", 8.0) or 8.0),
            ),
        )
    ...
    def _should_evaluate(self) -> bool:
        ...
        return (
            self.enabled and random.random() < self.sample_rate
        )  # nosec B311  # güvenlik değil örnekleme oranı amaçlıdır.
