...
class SocialMediaManager:
    ...
    def is_available(self, platform: str = "") -> bool:
        ...
        return any((self.instagram_business_account_id, self.facebook_page_id, self.whatsapp_phone_number_id))
    ...
    async def send_whatsapp_message(self, *, to: str, text: str, preview_url: bool = False) -> Tuple[bool, str]:
    ...
    async def publish_content(
        ...
        *,
        ...
        if normalized == "whatsapp":
            return await self.send_whatsapp_message(to=destination, text=text, preview_url=bool(link_url.strip()))
        return False, f"Desteklenmeyen sosyal medya platformu: {platform}"

    @staticmethod
    def build_content_preview(platform: str, text: str, *, media_url: str = "", link_url: str = "", destination: str = "") -> str:
        payload = {
