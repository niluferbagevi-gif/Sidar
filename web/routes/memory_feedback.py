...
def build_memory_feedback_router(*, cfg: Any, entity_memory_cache: dict[str, Any], feedback_store_cache: dict[str, Any]) -> LegacyExportRouter:
    ...
    @router.delete("/api/memory/entity/{user_id}/{key}", summary="Varlık Belleği Sil", tags=["EntityMemory"])
