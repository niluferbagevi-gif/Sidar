...
def build_auth_router(
    *,
    ...
    @router.get("/auth/me")
    async def auth_me(_request: Request, user: Any = Depends(get_request_user)) -> Any:
    ...
    async def admin_list_prompts(role_name: str = "", _user: Any = Depends(require_admin_user)) -> Any:
        agent = await resolve_agent_instance()
