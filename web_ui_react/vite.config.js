...
export function createSidarManualChunks(id) {
  if (!id.includes("node_modules")) {
    ...
    // fenced-code renderer alongside react-markdown/remark-gfm and their
    // (large, rarely-changing) transitive parser graph. Without its
    ...
    // for the remaining MarkdownBody vendor chunk.
